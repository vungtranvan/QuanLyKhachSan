 ...
 * @author hello
 */
public class AddKhuyenMai extends javax.swing.JInternalFrame {
     ...
     */
    public AddKhuyenMai(CallBackAdd _cb, ResourceBundle rb) {
        initComponents();
        resetText();
    ...
    public void translate(ResourceBundle rb) {
        ...
        jlbTitle.setText(this.rb.getString("AddKhuyenMai"));
    ...
    private void initComponents() {
        ...
        jlbTitle.setText("THÊM MỚI KHUYẾN MẠI");
    ...
    private void btnThemMoiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemMoiActionPerformed
        ...
        List<KhuyenMai> checkMaPhieu = khuyenMaiDAO.getByMaPhieuKhuyenMai(maPhieu);
        if (maPhieu.length() <= 0) {
        ...
        if (checkMaPhieu.size() == 1) {
            txtErrorMaPhieu.setText("Mã phiếu đã tồn tại");
            check = false;
        } else {
            txtErrorMaPhieu.setText("");
        }
        ...
        if (check == true) {
            int row = khuyenMaiDAO.add(new KhuyenMai(maPhieu, giaTriX, noiDung, dateBatDau, dateKetThuc, kieuTinh, trangThai));
            if (row > 0) {
