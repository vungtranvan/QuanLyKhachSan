...
public class UpdateKhachHang extends javax.swing.JInternalFrame {
     ...
     */
    public UpdateKhachHang(KhachHang khachhang, CallBackUpdate _cb, ResourceBundle rb) {
        initComponents();
        resetText();
    ...
    public void translate(ResourceBundle rb) {
        this.rb = rb;
        setTitle(this.rb.getString("UpdateKhachHang"));
        jlbTitle.setText(this.rb.getString("UpdateKhachHang"));
    ...
    private void initComponents() {
        ...
        jlbTitle.setText("CẬP NHẬT KHÁCH HÀNG");
