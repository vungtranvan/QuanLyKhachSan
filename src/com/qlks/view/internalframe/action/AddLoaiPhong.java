 ...
 * @author hello
 */
public class AddLoaiPhong extends javax.swing.JInternalFrame {
     ...
     */
    public AddLoaiPhong(CallBackAdd _cb, ResourceBundle rb) {
        initComponents();
        resetText();
    ...
    private void initComponents() {
        ...
        jlbTitle.setText("THÊM MỚI LOẠI PHÒNG");
    ...
    private void btnThemMoiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemMoiActionPerformed
        ...
        List<LoaiPhong> lstCheckID = loaiPhongDAO.getByMa(MaLP);
        if (lstCheckID.size() > 0) {
            txtErrorMaLP.setText("Mã loại phòng đã tồn tại !");
            check = false;
        }
        ...
        if (check == true) {
            txtErrorDonGia.setText("");
            int row = loaiPhongDAO.add(new LoaiPhong(MaLP, tenLP, donGiaX, soNgToiThieuX, soNgToiDaX, tyLeTangX));
            if (row > 0) {
